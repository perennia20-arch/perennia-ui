<script lang="ts">
    ...
    // SVELTE 5 STRICT MODE PROP FOR LAYOUT CHILDREN
    let { children } = $props();
...
{:else}
    <div class="h-screen w-screen bg-[#050505] text-white flex flex-col font-sans selection:bg-teal-500/30 overflow-hidden animate-[fade-in_1s_ease-out]">
        ...
        <header class="h-16 border-b border-neutral-800/80 bg-[#0a0a0a]/95 backdrop-blur-xl flex items-center justify-center z-50 shrink-0 w-full">
            <div class="w-full max-w-[1600px] px-6 lg:px-10 flex justify-between items-center h-full">
        ...
        <nav class="h-12 bg-[#050505] border-b border-neutral-800/60 flex justify-center w-full z-40 shrink-0 shadow-inner hide-scrollbar">
            <div class="w-full max-w-[1600px] px-6 lg:px-10 flex items-center justify-start overflow-x-auto h-full hide-scrollbar">
